...
from gui_dialogs_v3 import LogManager  # 导入日志管理器
...
class ZHTLLM_GUI(QMainWindow):
    def __init__(self):
        ...
        left_sidebar_layout.addWidget(self.project_manager_btn) # 修改
        ...
        # 版本信息
        self.version_label = QLabel("UI 20250724 v3")
    ...
    def connect_signals(self):
        ...
        self.project_manager_btn.clicked.connect(self.open_project_manager) # 修改
        ...
        self.meeting_mode_btn.clicked.connect(self.open_meeting_mode_dialog) # Connect the new button
    ...
    def execute_search(self):
        ...
        self.query_input.clear()  # 运行后清除输入
        self.run_build_btn.setEnabled(False)
        self.run_query_btn.setEnabled(False)
    ...
    def update_ui_text(self):
        ...
        self.project_manager_btn.setText(lang.get('create_or_delete_project')) # 修改
